...
var tSchema = "fmw121300";
var partNumber = "E38393-01";
...
function leftNav() {
  ...
  function addSimpleSearchForm() {
    ...
    if (!searchBook.value.match(/^[a-z]\d{5}$/) && !searchBook.value.match(/^[A-Z]{5}$/)) {
...
function addThisDocument() {
    var heading, a, li1, ul, thisDocument,
      ...
      nav_cookie_name = "ORA_" + "E38393_01" + "_NAV", error404 = 0,
